...
module.exports = function cleanDweet(canvas, dweet) {
  let c = canvas
  ...
  return function() {    
    ...
    function u(t) {
      r=Math.random;m=r(n=r(o=r(l=255)));t||(a=Array(w=2e3).fill(0));for(i=w;i--;x.fillStyle=R(l*m,l*n,l*o))x.fillRect(i,a[i],2,2),a[r()**2*w|0]++
    }
